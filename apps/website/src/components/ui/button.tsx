...
import { type VariantProps, intentAndSizeVariants } from "@/lib/utils";

const buttonVariants = intentAndSizeVariants(
  ...
  .defaults({ variant: "default", size: "default", loading: false });
